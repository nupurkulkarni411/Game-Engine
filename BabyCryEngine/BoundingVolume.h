...
struct BoundingBox
{
	D3DXVECTOR3 min; // Minimum extent of bounding box
	D3DXVECTOR3 max; //Max extent of bounding box
	float halfSize;  // Distance from centre of volume to farthest point of any axis
};

struct BoundingSphere
{
	D3DXVECTOR3 centre; //Centre point of bounding sphere
	float radius;
};
